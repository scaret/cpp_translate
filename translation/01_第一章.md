...
A problem can be better understood by answering this question: What  would the output be given certain input? Th erefore, it is a good idea to provide an example of the problem. Here are two problems with variable names selected to accurately describe the stored values:
...
> The important process of testing may, can, and should occur at any
...
> is 80.0, midterm is 90.0, and nalExam is 100.0 and the program outputs courseGrade as 90.0, what is wrong: the prediction, the program, or both?
