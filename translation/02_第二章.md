...
In addition to the Enter key, input data is also separated by one or more blank spaces. Th is makes it difficult to read in a string with blank spaces, such as a person’s full name or address. Given the following code:
