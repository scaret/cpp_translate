...
3-7 Trace the same algorithm with the diff erent example problem of rounding 9.99 to one decimal place. What is the result? Write the new value for x in the space provided (x changes state four times after being input).
>
> Algorithm
>
